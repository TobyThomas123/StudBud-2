...
})({"2izrc":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4e5dac8afe405db7";
module.bundle.HMR_BUNDLE_ID = "4691203d78e52e80";
"use strict";
...
submit.addEventListener("click", ()=>{
    ...
    if (setPomodoro.value < 10 && setPomodoro.value > 0) displayTime.textContent = `0${setPomodoro.value}:00`;
    else if (setPomodoro.value >= 10 && setPomodoro.value < 100) displayTime.textContent = `${setPomodoro.value}:00`;
    else if (setPomodoro.value >= 100) displayTime.textContent = `${setPomodoro.value}:00`;
    else if (setPomodoro.value < 0) alert("Please enter your time in minutes");
});

//# sourceMappingURL=timer.78e52e80.js.map
